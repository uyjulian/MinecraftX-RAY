...
public class Block
{
    ...
    {
    	//>>X-RAY>>//
        return !XrayMain.on && !XrayMain.cavefinder && XrayMain.lightmode != 2 ? par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]) : 1.0F;
        //<<X-RAY<<//
    ...
    {
    	//>>X-RAY>>//
        return (!XrayMain.on && !XrayMain.cavefinder && XrayMain.lightmode != 2) ? par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]) : 15728880;
        //<<X-RAY<<//
    ...
    {
    	//>>X-RAY>>//
        return !XrayMain.on && !XrayMain.cavefinder && XrayMain.lightmode <= 0 ? (par1IBlockAccess.isBlockNormalCube(par2, par3, par4) ? 0.2F : 1.0F) : (par1IBlockAccess.isBlockNormalCube(par2, par3, par4) ? 1.0F : 1.0F);
        //<<X-RAY<<//
