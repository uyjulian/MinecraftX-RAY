...
public class Block
{
    ...
    {
    	//>>X-RAY>>//
        return !mod_xray.on && !mod_xray.cavefinder && mod_xray.lightmode != 2 ? par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]) : 1.0F;
        //<<X-RAY<<//
    ...
    {
    	//>>X-RAY>>//
        return !mod_xray.on && !mod_xray.cavefinder && mod_xray.lightmode != 2 ? par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]) : 15728880;
        //<<X-RAY<<//
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        if (mod_xray.cavefinder)
        {
            var6 = mod_xray.blackList;
            var7 = mod_xray.blackList.length;
    ...
    {    	
    	//>>X-RAY>>//
        return !mod_xray.on && !mod_xray.cavefinder && mod_xray.lightmode <= 0 ? (par1IBlockAccess.isBlockNormalCube(par2, par3, par4) ? 0.2F : 1.0F) : (par1IBlockAccess.isBlockNormalCube(par2, par3, par4) ? 1.0F : 1.0F);
        //<<X-RAY<<//
